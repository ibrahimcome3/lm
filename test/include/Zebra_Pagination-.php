...
class Zebra_Pagination
{
    ...
    public function _show_next()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li><a class="ib" href="' .
                ...
                // if we're on the l_show_nextast page, the link is disabled
    ...
    public function _show_pages()
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                $output .= '<li><a class="ib" href="' . $this->_build_uri($i) . '" ' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li><a class="ib" href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '" ' .

                // highlight if the page is currently selected
                ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? 'class="ib current"' : '') . '>' .
            ...
            for ($i = $starting_page; $this->_properties['reverse'] ? $i >= $ending_page : $i <= $ending_page; $this->_properties['reverse'] ? $i-- : $i++)
                ...
                $output .= '<li><a class="ib" href="' . $this->_build_uri($i) . '" ' .
                    ...
                    ($this->_properties['page'] == $i ? 'class="ib current"' : '') . '>' .
            ...
            $output .= '<li><a class="ib" href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '" ' .
     ...
     *  @access private
     */
    public function _show_previous()
    {
