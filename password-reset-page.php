            		...
            		<div class="form-box" style="border: 1px solid blue">
            			<div class="form-tab">
							...
							<div class="tab-content">
							        ...
							        <div style="margin-top: 10px;"><center><h5><span class=""><?php if(isset($_GET['er'])){ echo $_GET['er'];} ?></span></h5></center></div>
							    	<?php } ?>
									<form action="password-reset-process-complete.php" method="post">
