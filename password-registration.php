                        			...
                        			<h2 class="checkout-title">Set your Password</h2><!-- End .checkout-title -->
                                        ...
                                        <div class="row">
                        					<div class="col-sm-6">
                        						...
                        						<input type="text" name="p2" class="form-control" required>
                        					</div><!-- End .col-sm-6 -->
                        				</div><!-- End .row -->
                                         <button type="submit" href="#" class="btn btn-outline-dark btn-rounded"><i class="icon-long-arrow-right"></i><span>Complete order</span></button>
