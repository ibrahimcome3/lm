            ...
            <div class="page-content pb-3">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                      <div class="EJP5Be _2p-a_9 _6t1WkM _3HqJxg"><div class="_1AtVbE col-12-12"><div class="_2Q9A4t"><div><h4 id="order-cancellation-and-return-policy">Order Cancellation and Return Policy</h4>
...
<p>GoodGuyng reserves the right to accept the cancellation of any order. GoodGuyng also reserves the right to waive off or modify the time window or cancellation fee from time to time.</p>
<br/>
<h4 id="returns-policy">Returns Policy</h4>
...
<p><span style="font-weight: 400;">Please note that GoodGuyng is an online marketplace and the final decision on replacement of defective device rests with the seller/brand</span></p>
<p><span style="font-weight: 400;">For Samsung, in case of DOA approved by brand, share the certificate of approval to the GoodGuyng customer support team to process your complaint</span></p>
<p><span style="font-weight: 400;">Authorized Service partner Locator for Brands: <a href="https://www.GoodGuyng.com/pages/service-partner-tnc"><span style="font-weight: 400;">Click here</span></a></span></p>
<p><span style="font-weight: 400;">For any other issues with the product, you may contact GoodGuyng - GoodGuyng’s 24×7 Customer Care</span></p>
...
<p>This policy shall be applicable only if the product was bought when this policy was applicable to the product. If not, the policy provided <a href="https://www.GoodGuyng.com/pages/returnpolicy">here</a> shall apply to the order. It is clarified that a customer may only be able to seek a one-time replacement under this Policy, subject to the other terms provided herein.</p>
<p>Exceptions to this policy: Following claims will be covered under the policy provided <a href="https://www.GoodGuyng.com/pages/returnpolicy">here</a> and through corresponding validation processes</p>
...
<p>You can view the complete list of non-returnable products <a href="http://www.GoodGuyng.com/no-return-products.php">here.</a></p>
</td>
</tr>
<tr>
<td valign="middle">
...
<td>
<p>The product’s original packaging/ box should be undamaged.</p>
</td>
</tr>
</thead>
</table>
...
<li>During open box deliveries, while accepting your order, if you received a different or a damaged product, you will be given a refund (on the spot refunds for cash-on-delivery orders). Once you have accepted an open box delivery, no return request will be processed, except for manufacturing defects. In such cases, these category-specific replacement/return general conditions will be applicable. <a href="open-box-delivery.php">Click here</a> to know more about Open Box Delivery</li>
<li>For products where installation is provided by GoodGuyng's service partners, do not open the product packaging by yourself. GoodGuyng authorised personnel shall help in unboxing and installation of the product.</li>
...
<p>GoodGuyng holds the right to restrict the number of returns created per order unit, post the evaluation of the product/order defect is undertaken by GoodGuyng’s authorized representative.</p>
</div></div></div></div>  
