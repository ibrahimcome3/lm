...
<div class="container px-4 text-center">
  <div class="row gx-5" style="border: 1px solid green">
    <div class="col">
     <div class="p-3"><h3>Welcome to Dispatch Guy</h3></div>
	 <div>
	 <img style="height: 350px; width: 100%;" src="img/dd.jpg"/>
	 </div>
    </div>
...
<div class="row justify-content-center">
		 ...
		 <div class="card" style="width: 18rem;">
		  ...
		  <div class="card-body">
			<p class="card-text">Director Disptach Guy</p>
		  </div>
		</div>
	...
	<div class="card" style="width: 18rem;">
	  <img src="img/b.jpg" class="card-img-top" alt="...">
	  <div class="card-body">
		<p class="card-text">Disptach Sheduler</p>
	  </div>
