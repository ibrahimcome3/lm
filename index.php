            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="index_pics/b2.png" alt="Banner">
                            </a>

                            <div class="banner-content">
                                <h4 class="banner-subtitle text-white d-none d-sm-block"><a href="#">Amazing Value</a></h4><!-- End .banner-subtitle -->
                                <h3 class="banner-title text-white"><a href="#">Food Spices <br>at lowest prices <br><span>from 3000 Naira</span></a></h3><!-- End .banner-title -->
